...
def rmse(predictions, binary=False, verbose=True):
...
def mae(predictions, binary=False, verbose=True):
...
def fcp(predictions, binary=False, verbose=True):
